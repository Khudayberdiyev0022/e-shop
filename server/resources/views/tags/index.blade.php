                ...
                <table class="table table-striped text-nowrap">
                  ...
                  @forelse($tags as $tag)
                    <tr>
                      ...
                      <td class="d-flex">
                        <a href="{{ route('tags.show', $tag->id) }}" class="btn btn-primary"><i class="fas fa-eye"></i></a>
                        <a href="{{ route('tags.edit', $tag->id) }}" class="btn btn-success mx-2"><i class="fas fa-edit"></i></a>
