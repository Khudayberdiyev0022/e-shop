            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <a href="{{ route('colors.edit', $color->id) }}" class="btn btn-success">Редактировать</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <dl class="row">
                  ...
                  <dd class="col-8">{{ $color->id }}</dd>
                  <dt class="col-4">Название</dt>
                  <dd class="col-8">{{ $color->title }}</dd>
                  <dt class="col-4">Дата создания</dt>
                  <dd class="col-8">{{ $color->created_at }}</dd>
                </dl>
              </div>
              <!-- /.card-body -->
            </div>
